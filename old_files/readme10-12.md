...
```py
  def print_fullname(firstname, lastname):
        ...
        print(full_name)
  print_fullname(firstname='apt-get2Update', lastname='Yetayeh')
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
generate_groups('Team-1','apt-get2Update','Brook','David','Eyob')
```
...
# main.py file
import mymodule
print(mymodule.generate_full_name('apt-get2Update', 'Yetayeh'))
```
...
[<< Part 3 ](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme7-9.md) | [Part 5 >>](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme13-15.md)
***
