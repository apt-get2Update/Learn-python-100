...
print(sentence) # I am apt-get2Update Yetayeh. I am a teacher. I live in Finland.
...
```py
 lst = ['apt-get2Update', 250, True, {'country':'Finland', 'city':'Helsinki'}] # list containing different data types
```
...
29. Find the middle country(ies) in the [countries list](  https://github.com/apt-get2Update/Learn-python-100/tree/master/data/countries.py)
...
[<< Part 1](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme.md) | [Part 3>>](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme7-9.md)