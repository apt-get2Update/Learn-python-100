...
```python
dct = {'name':'apt-get2Update','country':'Finland','city':'Helsinki'}
```
...
```python
data = [
    ['apt-get2Update', 'Finland', 'Helsink'], 
    ['David', 'UK', 'London'],
...
```python
data = {'Name': ['apt-get2Update', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'apt-get2Update', 'Country': 'Finland', 'City': 'Helsinki'},
...
```sh
apt-get2Update@apt-get2Update:~/Desktop$ mkdir python_for_web
apt-get2Update@apt-get2Update:~/Desktop$ cd python_for_web/
apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ virtualenv env
apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ source env/bin/activate
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ pip freeze
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ pip install Flask
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$
```
...
```sh
apt-get2Update@apt-get2Update:~$ heroku login
...
Logging in... done
Logged in as apt-get2Update@gmail.com
apt-get2Update@apt-get2Update:~$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ touch requirements.txt
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ touch Procfile
(env) apt-get2Update@apt-get2Update:~/Desktop/python_for_web$ ls
Procfile          env/              static/
...
```sh
mongodb+srv://apt-get2Update:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://apt-get2Update:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
from flask import Flask, render_template
import os # importing operating system module
MONGODB_URI = 'mongodb+srv://apt-get2Update:your_password_goes_here@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
db.students.insert_one({'name': 'apt-get2Update', 'country': 'Finland', 'city': 'Helsinki', 'age': 250})
print(client.list_database_names())
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'apt-get2Update', 'country': 'Helsinki', 'city': 'Helsinki', 'age': 250}
```
...
```sh
{'name': 'apt-get2Update', 'country': 'Finland'}
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'apt-get2Update', 'country': 'Finland', 'city': 'Helsinki', 'age': 250}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'Finland', 'city': 'Helsinki', 'age': 25}
```
...
The first person, apt-get2Update got a very implausible age. Let's update apt-get2Update's age.
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'apt-get2Update', 'country': 'Finland', 'city': 'Helsinki', 'age': 38}
{'_id': ObjectId('5df68a23f106fe2d315bbc8c'), 'name': 'David', 'country': 'UK', 'city': 'London', 'age': 34}
{'_id': ObjectId('5df68a23f106fe2d315bbc8d'), 'name': 'John', 'country': 'Sweden', 'city': 'Stockholm', 'age': 28}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'Finland', 'city': 'Helsinki', 'age': 25}
```
...
[<< Part 8 ](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme22-24.md) | [Part 10 >>](  https://github.com/apt-get2Update/Learn-python-100/blob/master/readme28-30.md)
